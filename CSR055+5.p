%------------------------------------------------------------------------------
% File     : CSR055+5 : TPTP v9.2.1. Bugfixed v3.5.0.
% Domain   : Common Sense Reasoning
% Problem  : Autogenerated Cyc Problem CSR055+5
% Version  : Especial.
% English  :
...
% Status   : Theorem
% Rating   : 0.67 v9.1.0, 0.70 v9.0.0, 0.72 v8.2.0, 0.75 v8.1.0, 0.81 v7.5.0, 0.84 v7.4.0, 0.87 v7.3.0, 0.86 v7.1.0, 0.78 v7.0.0, 0.83 v6.4.0, 0.81 v6.3.0, 0.83 v6.2.0, 0.96 v6.1.0, 0.97 v6.0.0, 0.91 v5.5.0, 1.00 v5.0.0, 0.92 v4.1.0, 0.96 v3.7.0, 1.00 v3.5.0
% Syntax   : Number of formulae    : 540250 (168244 unt;   0 def)
%            Number of atoms       : 920068 (  24 equ)
%            Maximal formula atoms :    4 (   1 avg)
%            Number of connectives : 389470 (9652   ~;   0   |;15895   &)
%                                         (   0 <=>;363923  =>;   0  <=;   0 <~>)
%            Maximal formula depth :   10 (   2 avg)
%            Maximal term depth    :    8 (   1 avg)
%            Number of predicates  : 103247 (103246 usr;   0 prp; 1-7 aty)
%            Number of functors    : 255474 (255474 usr;253179 con; 0-5 aty)
